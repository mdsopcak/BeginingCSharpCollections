...
namespace ReadAllCountries
{
    class PopulationFormatter
    {
        ...
        ///<summary>
        ///Returns the highest number that is a power of 10 and in no larger than the number supplied
        /// Examples:
        /// GetHighestPowerOfTen(11)
        /// GetHighestPowerOfTen(99)
        /// GetHighestPowerOfTen(100)
        /// GetHighestPowerOfTen(843)
        /// GetHighestPowerOfTen(1000)
        /// </summary>
